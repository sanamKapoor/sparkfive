...
export default {
  ...
  getCustomFields: (queryParams) => axios.get(`${shareCollectionsUrl}/custom-fields?${querystring.stringify(queryParams)}`),
  getCustomField: (id, queryParams) => axios.get(`${shareCollectionsUrl}/custom-fields/${id}?${querystring.stringify(queryParams)}`),
