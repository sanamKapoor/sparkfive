...
export default {
    ...
    getLinkDetail: (queryParams) => axios.get(`${linkUrl}/detail?${querystring.stringify(queryParams)}`),


    // Requests
    getRequests: (queryParams) => axios.get(`${requestUrl}?${querystring.stringify(queryParams)}`),
    getRequestAssets: (id, queryParams) => axios.get(`${requestUrl}/${id}/assets?${querystring.stringify(queryParams)}`),
}
