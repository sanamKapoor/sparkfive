...
module.exports = withSentryConfig(withImages({
  env: {
    ...
    SOCKET_BASE_URL: process.env.SERVER_BASE_URL ? `${process.env.SERVER_BASE_URL}` : "http://localhost:3000",
    ...
    GOOGLE_CLIENT_ID:
      process.env.GOOGLE_CLIENT_ID || "1003078561600-mf9f0cb0303di0ps9u8n3tgqvoddl7c6.apps.googleusercontent.com",
      //"1053631313639-o0m00gdem0cgd3agg6i4o0iop657llkk.apps.googleusercontent.com",
    GOOGLE_DEVELOPER_KEY:
      process.env.GOOGLE_DEVELOPER_KEY || "AIzaSyAYOOdG3qKk5ZSwoI-8WtXepioT1SdduyA",
