          ...
          return (
            <div
              ...
              className={`${styles.day} ${
                isSameMonth && styles["same-month"]
              } ${type === "week" && isSameWeekDates && styles["same-week"]} ${
                day.weekDay === 0 && styles["week-start"]
              } ${day.weekDay === 6 && styles["week-end"]}`}
            >
              <div
                className={`${styles["day-wrapper"]} ${
                  isSameDay && styles["same-day"]
                } `}
              >
                {day.date.getDate()}
              </div>
