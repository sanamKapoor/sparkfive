...
const UserTable = () => {
  const columns = ["User name", "Role","Last session date","Sessions","Downloads","Shares", "Actions",];
  const data = [
    ...
    { "User name": "John Ali",  Role: "Role name", "Last session date": "Today at 04:01pm", Sessions:"93",Downloads:"77",Shares:"30",  Actions: "Delete" },
    { "User name": "Betty Anderson",  Role: "Role name", "Last session date": "Today at 04:01pm", Sessions:"93",Downloads:"77",Shares:"30",  Actions: "Delete" },
    {"User name": "Eugene Atkinson",  Role: "Role name", "Last session date": "Today at 04:01pm", Sessions:"93",Downloads:"77",Shares:"30",  Actions: "Delete" },
