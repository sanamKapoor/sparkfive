  ...
  return (
    <section className={`${styles.container} card-content`}>
      ...
      <Select
        ...
        value={
          selectedPlan
            ? {
                ...selectedPlan,
                label: `${selectedPlan.nickname} Plan`,
        ...
        {selectedPlan ? (
          <div>
            {Intl.NumberFormat("en-IN", {
              style: "currency",
              currency: "USD",
            }).format(selectedPlan.amount / 100)}
          </div>
        ) : (
          <div>-</div>
        )}
      ...
      <p>
        ...
        {selectedPlan?.interval ? selectedPlan?.interval : "month"} after.
        Sparkfive subscriptions auto-renew{" "}
        {selectedPlan?.interval === "year" ? "yearly" : "monthly"} until you
        cancel.
      </p>
    </section>
  );
