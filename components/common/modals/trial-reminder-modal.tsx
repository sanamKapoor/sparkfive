...
const TrialReminderModal = () => {
  ...
  return (
    <Base modalIsOpen={active} closeModal={() => setActive(false)}>
      <div className={styles.container}>
        ...
        <p className={styles.desc}>
          In order to keep your team operating at full strength with Sparkfive,
          subscribe today
        </p>
        ...
        <p className={styles.desc}>
          Please don't hestitate to call us with any questions or contact us by
          email support@sparkfive.com
        </p>
