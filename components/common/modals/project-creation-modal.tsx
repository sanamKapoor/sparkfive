...
const ProjectCreationModal = ({ modalIsOpen, closeModal, initialValue = '', confirmCreation }) => {
    ...
    return (
        <Base
            ...
            disabledConfirm={!renameInput || channelInput === 'Select Channel' || !dateInput}
            confirmAction={async () => {
                confirmCreation({
                    name: renameInput,
            ...
            <div className={styles['input-wrapper']}>
                ...
                <div className={styles['properties-row']}>
                    <div className={styles['channel-wrapper']}>
                        <ChannelSelector
                            onLabelClick={() => { setDateInputActive(false) }}
