    ...
    return (
        <>
            ...
            <div className={styles.content}>
                ...
                {links.length > 0 && <div className={`row align-center ${styles['row-heading']} ${styles.desktop} font-weight-600`}>
                    ...
                    <div className={"col-10 col-sm-100 cursor-pointer d-flex justify-content-center align-items-center"}
                    ...
                    <div className={"col-15 col-sm-100 cursor-pointer d-flex justify-content-center align-items-center"}
                    ...
                    <div className={"col-25 col-sm-100 justify-content-center cursor-pointer d-flex align-items-center"}
                ...
                <div className={`row align-center ${styles['row-heading']} ${styles.mobile} font-weight-600`}>
                    Image Name
                </div>
                        ...
                        return (
                            <div className={`row align-center ${styles['data-row']}`} key={index}>
                                ...
                                <div className={"col-25 d-flex justify-content-center align-items-center word-break-text col-sm-100"}>
                                    ...
                                    <IconClickable additionalClass={`${styles['action-button']} m-l-15 cursor-pointer`}
                                        src={AssetOps[`copy${''}`]}
                                        tooltipText={'Copy'}
                                        tooltipId={'Copy'}
                                        onClick={() => {
                                ...
                                <div className={"col-10 d-flex justify-content-center align-items-center col-sm-100"}>
                                    <img src={ItemFields.member} alt="member icon" width={`10px`} />
                        ...
                        return (
                            <div className={`row ${styles['data-row']}`} key={index}>
                                <div className='d-flex align-items-center'>
                                    <div className={`${styles['file-name}']} font-14 font-weight-600`}>
                                        {link.name || "None"}
                                    </div>
                                ...
                                <div className={"row align-items-center gap-20"}>
                                    ...
                                    <div className={"d-flex align-items-center"}>
                                        ...
                                        <IconClickable additionalClass={`${styles['action-button']} m-l-10 cursor-pointer`}
                                            src={AssetOps[`copy${''}`]}
                                            tooltipText={'Copy'}
                                            tooltipId={'Copy'}
                                            onClick={() => {
                                    ...
                                    <span
                                        className={`font-12`}>
                                        Type: {parseTypeName(link.type, link.singleSharedCollectionId)}
                                    </span>
                                    <span className={"font-12"}>Expiration Date: {(link.expiredAt && link.expired) ? moment(link.expiredAt).format('MM/DD/YY') : "None"}</span>
                                    <div className={"d-flex align-items-center"}>
                                        <img src={ItemFields.member} alt="member icon" width={`10px`} />
