  ...
  return (
    ...
    >
      <div className={styles.container}>
        <p>
          The following file(s) already exists in your account. Do you want to
          use this uploaded version as the current version, change the filename
          or cancel the upload of these specific files?
        </p>
