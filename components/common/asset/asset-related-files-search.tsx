...
export default function AssetRelatedFilesSearch({ onSelect }){
    ...
    return <div className={styles.container}>
        <Search placeholder={"Search file to choose for association"} onChange={search} onClear={onClear} onlyInput={true} styleType={styles["search-input"]} inputContainerStyle={styles["input-container"]}/>
