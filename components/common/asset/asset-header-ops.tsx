	...
	return (
		<div className={styles.bar}>
			<div className={styles.wrapper}>
				...
				<div className={styles.text}>{!isFolder ? (totalSelectAssets) : selectedFolders.length} Assets Selected</div>
			...
			<div className={styles.icons}>
				...
				{((!isFolder && itemType && !isShare) && !deletedAssets) && <IconClickable place={'top'} additionalClass={styles['action-button']} src={AssetOps[`delete`]} tooltipText={'Remove'} onClick={() => setActiveOperation('remove_item')} />}
